...
RcppExport SEXP _partitions_Web_SamplerSP_fbl(SEXP data_SEXP, SEXP assignmentsSEXP, SEXP blSEXP, SEXP ASEXP, SEXP BSEXP, SEXP distortionsSEXP, SEXP paramsSEXP, SEXP n_samplesSEXP, SEXP spacingSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< IntegerMatrix >::type data_(data_SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_partitions_Web_SamplerSP_fbl", (DL_FUNC) &_partitions_Web_SamplerSP_fbl, 9},
    {NULL, NULL, 0}
};
