...
the partitions package to perform entitiy resolution with categorical variables using partition-based Bayesian clustering models.
...
* Two traditional clustering models: Dirichlet process (DP) mixtures and Pitman–Yor process (PY) mixtures. 
